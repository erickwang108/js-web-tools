...
const initializers = {
  HTMLEvents(el, name, event, o) {
    return event.initEvent(name, o.bubbles, o.cancelable);
  },

  KeyboardEvent(el, name, event, o) {
 ...
 */
export default function eventTrigger(el, name, options) {
  var event, type;
